package com.fenglei.common.result;
...
public enum ResultCode implements IResultCode, Serializable {
    ...
    CUSTOMER_CONTACT_NOT_EXIST("A0204", "客户联系人不存在"),
    ...
    DOMAIN_NOT_EXIST("C0351", "未找到对应实体"),
    NAME_REPEAT("C0361", "名称重复"),
