...
public final class DateUtil {
    ...
    public static int getSecondTimestamp(){
        Date date = strToDate(nowDateTime("yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss");
        if (null == date) {
            return 0;
        }
        String timestamp = String.valueOf(date.getTime()/1000);
    ...
    public static String getWeekEndDay() {
        return addDay(getWeekStartDay(), 7, "yyyy-MM-dd HH:mm:ss");
    }
    ...
    public static String getLastWeekEndDay() {
        return addDay(getLastWeekStartDay(), 7, "yyyy-MM-dd HH:mm:ss");
    }
