...
public interface SysPermissionMapper extends BaseMapper<SysPermission> {
    ...
    @Results({
            @Result(property = "roleIds", column = "id", many = @Many(select = "com.fenglei.mapper.system.SysRolePermissionMapper.listRoleIds"))
    })
    ...
    List<String> listPermsByRoleIds(@Param("roleIds") List<String> roleIds, @Param("type") Integer type);
