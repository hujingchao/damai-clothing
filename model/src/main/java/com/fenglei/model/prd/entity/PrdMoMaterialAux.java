 ...
 */
@Data
@ApiModel(value = "PrdMoMaterialAux-生产订单 辅料详情", description = "生产订单 辅料详情类")
@TableName(value = "prd_mo_material_aux")
public class PrdMoMaterialAux extends UBillItemBaseEntity {
