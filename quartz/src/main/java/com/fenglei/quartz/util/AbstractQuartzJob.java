...
import com.fenglei.common.util.ExceptionUtil;
import com.fenglei.common.util.SpringUtils;
import com.fenglei.common.util.StringUtils;
import com.fenglei.common.util.bean.BeanUtils;
...
public abstract class AbstractQuartzJob implements Job {
    ...
    protected void after(JobExecutionContext context, SysJob sysJob, Exception e) {
        ...
        // 写入数据库当中
        SpringUtils.getBean(SysJobLogMapper.class).addJobLog(sysJobLog);
    }
